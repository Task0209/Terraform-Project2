...
resource "aws_iam_policy" "Lamda-policy-cloudwatch-logs" {
 
 name         = "Lamda-policy-cloudwatch-logs"
 path         = "/"
...
resource "aws_iam_role_policy_attachment" "Lamda-policy-cloudwatch-logs-docs" {
 role        = aws_iam_role.lambda_role.name
 policy_arn  = aws_iam_policy.Lamda-policy-cloudwatch-logs.arn
}
